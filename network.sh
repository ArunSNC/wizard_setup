#!/bin/bash
### Setup a wifi Access Point on Ubuntu (or its derivatives).


##############################################################
## setup wizard dns (Interrupt Sub Routine)
##############################################################

set_wizard_dns(){

echo "Setting up wizard DNS"

cat <<EOF >> /etc/hosts

#### IPV4 WIZARD DNS #######

10.10.0.1    wizard.stupify.com
...
##############################################################
## create startup entry (Interrupt Sub Routine)
##############################################################
...
### install hostapd
apt-get -y install hostapd lshw
